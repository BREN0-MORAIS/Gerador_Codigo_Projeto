...
{
    public class RepositoryPostgresDapper : IRepositoryDapper
    {
        private readonly ApplicationDbContext _db;
        private string _connectionString = string.Empty;

        public RepositoryPostgresDapper(ApplicationDbContext db)
        {
            _db = db;
        ...
        {
            using (var sqlCon = new NpgsqlConnection(_connectionString))
            {
                sqlCon.Open();
